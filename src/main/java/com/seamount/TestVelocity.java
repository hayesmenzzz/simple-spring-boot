...
import com.seamount.common.support.Fild;


public class TestVelocity {

	private static final String driver = "com.mysql.jdbc.Driver";
	private static final String url = "jdbc:mysql://localhost:3306/activiti-explorer?useUnicode=true&characterEncoding=utf-8";
...
//	private static String  rootPath = "D:\\work-dir\\midai-git\\oa-dev-new\\midai-master\\"; // 物理目录
	...
	private static void createProvider() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		merge(providerTmp, providerCtx, rootPath
				+ "midai-oa-service-impl/src/main/java/com/midai/car/provider/" + classNameUpCase
				+ "Provider.java");
	...
	private static void createQuery() throws ResourceNotFoundException, ParseErrorException, Exception{
		...
		merge(queryTmp, queryCtx, rootPath
				+ "midai-oa-service-api/src/main/java/com/midai/car/query/" + classNameUpCase
				+ "Query.java");
