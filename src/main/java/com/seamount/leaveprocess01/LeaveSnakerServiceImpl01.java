...
import com.seamount.leaveprocess.LeaveApplyProcessService;
import com.seamount.leaveprocess.LeaveProcessRunStateEnum;
import com.seamount.snaker.SnakerEngineFacets;

@Service("leaveSnakerServiceImpl")
public class LeaveSnakerServiceImpl01 implements LeaveSnakerService01 {

	private final static Logger log = LoggerFactory.getLogger(LeaveSnakerServiceImpl01.class);
...
//	private MobileContentDao mobileContentDao;
	...
	public void startProcess(String businessId, String operator, Map<String, Object> variables) {
		...
		try {
			String processId = "";
			Process processByName = snakerEngineFacets.getProcessService().getProcessByVersion("leaveProcess01", 0);
